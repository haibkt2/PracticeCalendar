...
public class ReadWord {
	...
	public static void main(String[] args) throws Exception {
		...
		InputStream is = new BufferedInputStream(new FileInputStream("D:\\td\\test.docx")); // really a binary OLE2 Word
																							// file
		System.out.println(read(is));
		is.close();

//		is = new BufferedInputStream(new FileInputStream("D:\\td\\d.doc")); // a OOXML Word file named *.doc
//		System.out.println(read(is));
//		is.close();
//
