											...
											<div class="box-body">
												<table id="example1"
													...
													<tbody>
															...
															<tr>
																<td>
																	<button type="button" class="btn btn-primary"
																		...
																		${listRoom.getRoomName()}</button>
																</td>
																<c:forEach begin="0" end="6" varStatus="loop">
																<td style="background-color: #00c0ef52">
																<a href="#">
																<span>
																		Sáng:
																</span> <strong
														...
														<!-- <tr>
                           <td>
                             <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#class-info" style="margin-top: 15px;">
                                C101
                             </button>
                           </td>
                           <td style="background-color: #00c0ef52">
                               ...
                               <strong style="padding-left: 10px; padding-right: 15px;">
                                 <a  data-toggle="modal" data-target="#booking-info">
                                  30/40
                                 </a>
                               </strong>
