			...
			<div class="container">
				<div class="header-links">
					<ul>
						...
						<li><a href="${contextPath}/loginOrSigin.jsp"><i class="fa fa-sign-in"></i> Login</a></li>
						<li></li>
						</c:if>
						
						<c:if test="${not empty userLogin}">
						<%-- 
						<li><a href="${contextPath}/logout" class="fa fa-sign-in"> Logout</a></li>
						
						--%>
						<li><a href="javascript:document.forms['logoutForm'].submit();"><i class="fa fa-sign-in"></i>Logout</a></li>
						<li>Welcome <i style="color: red">${userLogin}</i></li>
							<form id="logoutForm" method="POST" action="${contextPath}/logout"><input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
							</form>
						</c:if>
					</ul>
				</div>
