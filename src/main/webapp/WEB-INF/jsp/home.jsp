...
<html lang="en">
	...
	<body>
		...
		<div id="owl-carousel-1" class="owl-carousel owl-theme center-owl-nav">
			...
			<article class="article thumb-article">
				<div class="article-img">
					<img src="${contextPath}/resources/img/img-lg-1.jpg" alt="">
				</div>
			...
			<article class="article thumb-article">
				<div class="article-img">
					<img src="${contextPath}/resources/img/img-lg-2.jpg" alt="">
				</div>
				<div class="article-body">
					<ul class="article-info">
						<li class="article-category"><a href="#">News</a></li>
			...
			<article class="article thumb-article">
				<div class="article-img">
					<img src="${contextPath}/resources/img/img-lg-3.jpg" alt="">
				</div>
				<div class="article-body">
					<ul class="article-info">
						<li class="article-category"><a href="#">News</a></li>
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-6">
										...
										<article class="article">
											<div class="article-img">
												<a href="#">
													<img src="${contextPath}/resources/img/img-md-4.jpg" alt="">
												</a>
												<ul class="article-info">
													<li class="article-type"><i class="fa fa-file-text"></i></li>
												</ul>
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-6">
										...
										<article class="article widget-article">
											<div class="article-img">
												<a href="#">
													<img src="${contextPath}/resources/img/img-widget-1.jpg" alt="">
												</a>
											</div>
											<div class="article-body">
												<h4 class="article-title"><a href="#">Thông báo đợt xét tốt nghiệp cuối học kỳ 2</a></h4>
										...
										<article class="article widget-article">
											<div class="article-img">
												<a href="#">
													<img src="${contextPath}/resources/img/img-widget-2.jpg" alt="">
												</a>
											</div>
											<div class="article-body">
												<h4 class="article-title"><a href="#">Thông báo đợt xét tốt nghiệp cuối học kỳ 2</a></h4>
									...
									<div class="col-md-4 col-sm-6">
										...
										<article class="article widget-article">
											<div class="article-img">
												<a href="#">
													<img src="${contextPath}/resources/img/img-widget-4.jpg" alt="">
												</a>
											</div>
											<div class="article-body">
												<h4 class="article-title"><a href="#">Thông báo đợt xét tốt nghiệp cuối học kỳ 2</a></h4>
									...
									<div class="col-md-4 hidden-sm">
										...
										<article class="article widget-article">
											<div class="article-img">
												<a href="#">
													<img src="${contextPath}/resources/img/img-widget-5.jpg" alt="">
												</a>
											</div>
											<div class="article-body">
												<h4 class="article-title"><a href="#">Thông báo đợt xét tốt nghiệp cuối học kỳ 2</a></h4>
										...
										<article class="article widget-article">
											<div class="article-img">
												<a href="#">
													<img src="${contextPath}/resources/img/img-widget-6.jpg" alt="">
												</a>
											</div>
											<div class="article-body">
												<h4 class="article-title"><a href="#">Thông báo đợt xét tốt nghiệp cuối học kỳ 2</a></h4>
				...
				<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6">
								...
								<article class="article widget-article">
									<div class="article-img">
										<a href="#">
											<img src="${contextPath}/resources/img/img-widget-8.jpg" alt="">
										</a>
									</div>
									<div class="article-body">
										<h4 class="article-title"><a href="#">Thông báo đợt xét tốt nghiệp cuối học kỳ 2</a></h4>
							...
							<div class="col-md-6 col-sm-6">
								...
								<article class="article widget-article">
									<div class="article-img">
										<a href="#">
											<img src="${contextPath}/resources/img/img-widget-10.jpg" alt="">
										</a>
									</div>
									<div class="article-body">
										<h4 class="article-title"><a href="#">Thông báo đợt xét tốt nghiệp cuối học kỳ 2</a></h4>
					...
					<div class="col-md-4">
						...
						<div class="widget center-block hidden-xs">
							<img class="center-block" src="${contextPath}/resources/img/ad-1.jpg" alt=""> 
						</div>
						<!-- /Ad widget -->
		...
		<div class="visible-lg visible-md">
			<img class="center-block" src="${contextPath}/resources/img/ad-3.jpg" alt="">
		</div>
		<!-- /AD SECTION -->
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="widget galery-widget">
							...
							<ul>
								<li><a href="#"><img src="${contextPath}/resources/img/img-widget-3.jpg" alt=""></a></li>
								<li><a href="#"><img src="${contextPath}/resources/img/img-widget-4.jpg" alt=""></a></li>
								<li><a href="#"><img src="${contextPath}/resources/img/img-widget-5.jpg" alt=""></a></li>
								<li><a href="#"><img src="${contextPath}/resources/img/img-widget-6.jpg" alt=""></a></li>
								<li><a href="#"><img src="${contextPath}/resources/img/img-widget-7.jpg" alt=""></a></li>
								<li><a href="#"><img src="${contextPath}/resources/img/img-widget-8.jpg" alt=""></a></li>
								<li><a href="#"><img src="${contextPath}/resources/img/img-widget-9.jpg" alt=""></a></li>
								<li><a href="#"><img src="${contextPath}/resources/img/img-widget-10.jpg" alt=""></a></li>
							</ul>
						</div>
						<!-- /galery widget -->
